...
# compile apex lib
clang -O0 -g -c -emit-llvm ${INPUT_LIB} -o build/${BYTECODE_FROM_APEXLIB}


echo "========= Linking input with apex lib."
# We are linking input after basic opts.
llvm-link build/${BYTECODE_FROM_APEXLIB} ../${BYTECODE_FROM_INPUT} -S -o=build/${LINKED_DISASSEMBLY}
